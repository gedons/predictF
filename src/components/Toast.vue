    ...
    <div class="fixed top-4 right-4 z-50 space-y-2">
      <transition-group name="toast" tag="div">
        <div
          ...
          :key="toast.id"
          class="flex items-center p-4 rounded-lg shadow-lg backdrop-blur-sm border max-w-md"
        ...
        >
          ...
          >
            <svg class="w-4 h-4" :class="textClasses(toast.type)" fill="currentColor" viewBox="0 0 20 20">
